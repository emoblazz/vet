...
<head>
  ...
  <title><?php include '../dist/includes/title.php';?> | Species</title>
            ...
            <div class="card card-outline card-success">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  $query=mysqli_query($con,"select * from species order by species_name")or die(mysqli_error());
                    $i=0;
                            ...
                            <form method="post" action="functions.php">
                              ...
                              <div class="modal-body">
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="text" class="form-control" id="inputEmail3" placeholder="Species" name="species" value="<?php echo $species;?>" required>
                              ...
                              <div class="modal-footer justify-content-between">
                                ...
                                <button type="submit" class="btn btn-success" name="update_species">Save changes</button>
                              </div>
                            </form>
                          </div>
                          <!-- /.modal-content -->
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <form method="post" action="functions.php">
                              ...
                              <div class="modal-body">
                                <p>Are you sure you want to delete <?php echo $species;?>?</p>
                                <input type="hidden" class="form-control" id="inputEmail3" placeholder="Category" name="id" value="<?php echo $id;?>">
                              </div>
                              <div class="modal-footer justify-content-between">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                <button type="submit" class="btn btn-success" name="delete_species">Delete</button>
                              </div>
                            </form>
                          </div>
                          <!-- /.modal-content -->
              ...
              <div class="card-footer bg-transparent">
                <div class="row">
                  <div class="col-12 text-center">
                    <button type="submit" class="btn btn-success btn-block" name="add_species"><i class="fa fa-save"></i> Save</button>
                  </div>
                </div>
                <!-- /.row -->
              </div>
